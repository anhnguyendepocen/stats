...
2. The estimate of the slope of the relationship between the covariate and the dependent variable ($\beta$ in Equation~\ref{eq:ancovafull} above) allows you to numerically adjust scores on the dependent variable, and ask the (often useful) question: \emph{What would scores have been on the dependent variable IF the groups had been equal on the covariate?}
